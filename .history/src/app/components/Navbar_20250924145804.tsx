    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          {/* Enlace WhatsApp */}
          <a
            href="https://wa.link/3emlzn"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center rounded-lg border border-green-500 text-green-600 px-4 py-2 text-sm font-semibold hover:bg-green-50"
          >
            WhatsApp
          </a>
        </nav>
        ...
        <div className="md:hidden border-t border-gray-200 bg-white">
          <div className="space-y-2 px-4 py-4">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setOpen(false)}
              className="block rounded border border-green-500 px-3 py-2 text-center text-sm font-semibold text-green-600 hover:bg-green-50"
            >
              WhatsApp
            </a>
          </div>
